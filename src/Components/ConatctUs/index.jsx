    ...
    return (
        <div>
            ...
            <div className='d-flex p-5'>
                ...
                <img src='/images/contactus.jpeg' className="px-5" height={350}></img>

            </div>
            <div className='d-flex p-5 justify-content-center '>
                <div className='px-5 shadow-sm'>
                    <IoCall className='display-1 mb-2' style={{ marginLeft: "30px" }} />
                    <h4>Talk to Sales</h4>
                ...
                <div className='px-5 shadow-sm'>
                    <LuMessagesSquare className='display-1 mb-2' style={{ marginLeft: "90px" }} />
